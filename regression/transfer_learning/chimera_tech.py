...
from regression.jamshidi import ImportanceFeatureSelector
...
class ChimeraTech(TransferLearning):
    def __init__(self, workload, system, target_data_path: str, instance_similarity: ParameterImportanceSimilarity):
        ...
        self.feature_selector = ImportanceFeatureSelector(self.base_df, self.system)
    ...
    def fit(self) -> None:
        params = self.system.get_param_names()
