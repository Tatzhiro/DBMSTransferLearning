...
from regression import group_features, read_data_csv, Pipeline
...
def main(cfg: DictConfig) -> None:
    ...
    df_mean = pd.DataFrame(index=sample_sizes)
    for key in models:
        ...
        mean_scores = [np.nanmean(trials[size]) for size in sample_sizes]
